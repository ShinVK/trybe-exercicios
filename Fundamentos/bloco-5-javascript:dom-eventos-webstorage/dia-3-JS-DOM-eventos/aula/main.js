...
// com a classe 'tech';
function addTxtToClassTech(event) {
  const techClass = document.querySelector('.tech');
  techClass.innerText = event.target.value;
}

input.addEventListener('input', addTxtToClassTech);
...
//   window.location.replace('https://shinvk.github.io/');
// });

myWebpage.addEventListener('dblclick', function () {
  window.open('https://shinvk.github.io/');
});
...
myWebpage.addEventListener('mouseover', changeColorTxt);
