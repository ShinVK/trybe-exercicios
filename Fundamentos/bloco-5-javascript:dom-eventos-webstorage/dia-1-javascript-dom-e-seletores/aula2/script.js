const bggreen = document.querySelector("#header-container");
bggreen.style.background = "#2fc18c";

document.querySelectorAll(".emergency-tasks h3")[0].style.background = "#a51ff2";
